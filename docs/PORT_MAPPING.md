...
- Frontend: Port 3000
- Backend Services: Ports >= 4000 (tránh conflict)
...
| Auth Service         | 4001 | HTTP health endpoint |
| Video Service        | 4002 | HTTP health endpoint |
| Interaction Service  | 4003 | HTTP health endpoint |
| Notification Service | 4004 | HTTP health endpoint |
...
AUTH_HTTP_PORT=4001
VIDEO_HTTP_PORT=4002
INTERACTION_HTTP_PORT=4003
NOTIFICATION_HTTP_PORT=4004
